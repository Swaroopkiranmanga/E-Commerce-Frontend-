...
const CustomerCreate = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log("event");
    axios.post('http://localhost:8081/register', {"username":ref1.current.value, "email":ref2.current.value,"password":ref3.current.value,"phoneNumber":ref4.current.value})
      .then(response => {
       alert(response);
